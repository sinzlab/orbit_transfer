...
class RDMPrediction(MainLoopModule):
    def __init__(self, trainer):
        ...
        objectives = {  # TODO: make adaptable to other tasks!
            "Training": {"regression": {"RDMPrediction": 0}},
            "Validation": {"regression": {"RDMPrediction": 0}},
            "Test": {"regression": {"RDMPrediction": 0}},
        }
